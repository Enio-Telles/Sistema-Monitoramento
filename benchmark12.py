...
df = pl.DataFrame({
    ...
    "lista_descricoes_normalizadas": [["norm"] for _ in range(n_rows)],
...
# Cast string columns explicitly
df = df.with_columns([
    pl.col("descrição_normalizada").cast(pl.String),
    pl.col("descricao").cast(pl.String),
    pl.col("codigo_padrao").cast(pl.String),
    pl.col("tipo_item_padrao").cast(pl.String),
    pl.col("NCM_padrao").cast(pl.String),
    pl.col("CEST_padrao").cast(pl.String),
    pl.col("GTIN_padrao").cast(pl.String),
    pl.col("descricao_padrao").cast(pl.String),
    pl.col("lista_tipo_item").cast(pl.List(pl.String)),
    pl.col("lista_ncm").cast(pl.List(pl.String)),
    pl.col("lista_cest").cast(pl.List(pl.String)),
    pl.col("lista_gtin").cast(pl.List(pl.String)),
    pl.col("lista_unid").cast(pl.List(pl.String)),
    pl.col("lista_descricoes").cast(pl.List(pl.String))
])

target_dir = Path("/tmp/cnpj_dir_12")
