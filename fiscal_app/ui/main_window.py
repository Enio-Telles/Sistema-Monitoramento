...
class MainWindow(QMainWindow):
    ...
    def _setup_table_view(self, tv: QTableView) -> None:
        tv.setAlternatingRowColors(True)
        tv.setWordWrap(True)
        tv.verticalHeader().setDefaultSectionSize(60)
        tv.horizontalHeader().setMinimumSectionSize(40)
        tv.horizontalHeader().setDefaultSectionSize(200)
        tv.horizontalHeader().setMaximumSectionSize(300)
        tv.setStyleSheet("QTableView::item { padding: 4px 2px; }")
    ...
    def _build_tab_consulta(self) -> QWidget:
        ...
        self._setup_table_view(self.table_view)
    ...
    def _build_tab_agregacao(self) -> QWidget:
        ...
        self._setup_table_view(self.aggregation_table_view)
        ...
        self._setup_table_view(self.results_table_view)
